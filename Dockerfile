...
RUN --mount=type=cache,id=8bba0451-4476-4349-b1c0-0b84f5bc84b6-pnpm-store,target=/root/.local/share/pnpm/store pnpm fetch | grep -v "cross-device link not permitted\|Falling back to copying packages from store"

RUN --mount=type=cache,id=8bba0451-4476-4349-b1c0-0b84f5bc84b6-pnpm-store,target=/root/.local/share/pnpm/store pnpm install -r --offline
